Thank you for downloading Gorilla.

This is a semi realistic 3d model and animations of Gorilla. 
-Models folder contains GorillaModelLowPoly.FBX, GorillaModelTowLODs.FBX,
...
Demo folder contains an example use of the Gorilla model. 
